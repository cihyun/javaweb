			...
			<table class="table text-center">
				...
				<tr>
					...
					<td><input type="password" name="pwd" id="pwd"
						value="${vo.pwd}" required class="form-control" /></td>
				</tr>
				<tr>
					<th>성명</th>
				...
				<tr>
					<td colspan="2" class="text-center">
						...
						<input type="submit" value="저장" class="btn btn-success mr-2" /> <input
						type="reset" value="다시입력" class="btn btn-danger mr-2" /> <input
						type="button" value="돌아가기"
						onclick="location.href='${ctp}/study/0428_database/memberMain.jsp';"
