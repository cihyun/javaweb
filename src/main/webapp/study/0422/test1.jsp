...
<div class="container mt-5">
	<form name="loginForm" method="post" class="mt-4" action="test1Ok.jsp">
		<table class="table table-bordered" style="width:500px; height:250px;" style="text-align:center;">
		  ...
		  <tr>
		    <th colspan="2" class="text-center">
		      <input type="button" value="로그인" onclick="loginCheck()" class="btn btn-info" />
		      <input type="reset" value="다시입력" class="btn btn-warning ml-2" />
		    </th>
		  </tr>
		</table>
	</form>
