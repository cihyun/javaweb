	...
	<h3>처리된 자료를 view에 출력시켜 본다.</h3>
		<table class="table table-boarded">
			...
			<tr>
				...
				<td>${age+1} / <jsp:setProperty property="age" name="vo" /></td>
			</tr>
			<tr>
				<th>성별</th>
				<td>${gender} / <jsp:setProperty property="gender" name="vo" /></td>
			</tr>
			<tr>
				<th>직업</th>
				<td>${job} / <jsp:setProperty property="job" name="vo" /></td>
			</tr>
			<tr>
				<th>주소</th>
				<td>${address} / <jsp:setProperty property="address" name="vo" /></td>
			</tr>
		</table>
