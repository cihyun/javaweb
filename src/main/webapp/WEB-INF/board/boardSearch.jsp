...
<p><br/></p>
<div class="container">
  <h2 class="text-center mb-5">검색결과</h2>
  <h3 class="text-center mb-3">
	<b> ${searchTitle} 으로 <font color="blue">${searchString}</font> (을)를 검색한 결과, 
	<font color="blue">${searchCount}</font> 건이 검색되었습니다. </b>
  </h3>
  ...
  <div class="text-right">
  	<a href="${ctp}/BoardList.bo?pag=${pag}&pageSize=${pageSize}" class="btn btn-info">목록</a>
  </div>
</div>
<p><br/></p>
