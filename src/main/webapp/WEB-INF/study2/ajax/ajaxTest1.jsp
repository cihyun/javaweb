...
<jsp:include page="/include/header.jsp" />
	...
	<div class="container">
		...
		<form name="myform">
			...
			<input type="button" value="아이디일반검색" onclick="idCheck()" class="btn btn-success btn-sm ml-2" /><br />
			<hr />
			aJax검색 : 
			<input type="button" value="아이디검색1" onclick="idCheck1()" class="btn btn-warning btn-sm ml-2" />
			<input type="button" value="아이디검색2" onclick="idCheck2()" class="btn btn-primary btn-sm ml-2" />
			<input type="button" value="아이디검색3" onclick="idCheck3()" class="btn btn-secondary btn-sm ml-2" />
			<input type="button" value="아이디검색4" onclick="idCheck4()" class="btn btn-danger btn-sm ml-2" />
			<input type="button" value="아이디검색5" onclick="idCheck5()" class="btn btn-info btn-sm ml-2" /><br />

			<div class="mt-3">
				출력결과 : <span id="demo"></span>
			</div>
			<hr />
			<div>
